<?php
/**
 * Z-FINANCE 1.0.0 - REST API: Income Categories
 * Endpoint: /modules/income/api/categories.php
 */
...
require_once __DIR__ . '/../classes/IncomeCategoryManager.php';
...
$catManager = new IncomeCategoryManager($pdo);
