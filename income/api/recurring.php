<?php
/**
 * Z-FINANCE 1.0.0 - REST API: Recurring Income
 * Endpoint: /modules/income/api/recurring.php
 */
...
require_once __DIR__ . '/../classes/RecurringIncomeManager.php';
...
$recManager = new RecurringIncomeManager($pdo);
